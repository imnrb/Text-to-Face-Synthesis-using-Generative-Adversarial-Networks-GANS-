...
#Load models
netG.load_state_dict(torch.load(r'D:\BE_Major_Project\Projects\DFGAN\model\generator_epoch60.pt'))
netD.load_state_dict(torch.load(r'D:\BE_Major_Project\Projects\DFGAN\model\discriminator_epoch60.pt'))
...
# '''])
# test_embeddings = sentence_encoder.convert_text_to_embeddings(['The woman has high cheekbones.She has straight hair which is brown in colour. She has arched eyebrows and a slightly open mouth. The smiling, young attractive woman has heavy makeup. She is wearing lipstick.'])

with open(r'D:\BE_Major_Project\Projects\DFGAN\example_captions.txt','r') as f:
   caption = f.read()
   print(f"file captions: {caption}")
...
save_path = r'D:\BE_Major_Project\Projects\DFGAN\Output\generated_image.png'
# Save the image
